...
%global pkg_name linear_feedback_controller_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-linear-feedback-controller-msgs
Version:        1.3.0
Release:        1%{?dist}
...
%changelog
* Wed Sep 09 2026 Guilhem Saurel <guilhem.saurel@laas.fr> - 1.3.0-1
- Autogenerated by Bloom

* Wed Apr 29 2026 Guilhem Saurel <guilhem.saurel@laas.fr> - 1.2.2-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Guilhem Saurel <guilhem.saurel@laas.fr> - 1.2.2-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Guilhem Saurel <guilhem.saurel@laas.fr> - 1.2.2-1
- Autogenerated by Bloom
